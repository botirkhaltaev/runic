...
- Freelist head and intrusive links are `BlockIndex` values; allocate resolves an index to a payload pointer. Frees of user pointers validate block boundaries via `block_at`.
