...
- Live large ownership for reclaim is `Heap::extent_live`, with `ExtentHeap::has_live` scanning Allocated/Claimed for isolated tests. Cached Free extents do not block reclaim.
